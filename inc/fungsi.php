...
function populer()
{
	?>
	<!--berita populer-->
		<div class="bar-menu card text-white color-5 no-border mb-3">
			Berita Populer
		</div>
		...
		<div>
			...
			while ($r = mysqli_fetch_array($pop)) {
				...
				<div class="side-box">
					...
					<span><b>'.substr($Tanggal, 0, 10).'</b> | view: <b>'.$Viewnum.'</b> </span>

					<h1><a class="text-dark" href="./?open=detail&id='.$ID.'">'.$Judul.'</a></h1>
					<div class="clear"></div>
				</div>
