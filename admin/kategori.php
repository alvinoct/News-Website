...
<div class="w100">
	<form action="./?mod=kategori" method="POST">
		...
		<fieldset>
			...
			<input class="btn color-5 text-white no-border" type="submit" name="<?=(isset($ID) ? 'editkategori' : 'tambahkategori');?>" value="<?=(isset($ID) ? 'Edit' : 'Tambah');?>">
		</fieldset>
	</form>
...
<div class="w100">
		<fieldset>
			...
			<div class="w100 fl list color-5 text-white">
			...
			<div class="w100 fl list">
				...
				<div class="w30 fl"><?=$alias?></div>
				<div class="w20 fl">
					<a href="./?mod=kategori&act=edit&id=<?=$ID?>" class="btn btn-primary small">Edit</a> <a href="./?mod=kategori&act=hapus&id=<?=$ID?>" class="btn btn-danger ">Delete</a> 
