...
<div class="w100">
	<form action="./?mod=berita" method="POST" enctype="multipart/form-data">
		...
		<fieldset>
			...
			<input type="submit" name="add" value="<?=(isset($id) ? 'Edit' :'Tambah')?>" class="btn color-5 text-white no-border">
...
<div class="w100">
	<fieldset>
		...
		<div class="w100 list fl bold color-5 text-white">
		...
		while ($b = mysqli_fetch_array($hasil)) {
			...
			<div class="w20 fl"><?=$Tanggal;?></div>
			<div class="w10 fl">
				<a href="./?mod=berita&act=edit&id=<?=$ID;?>" class="btn btn-primary ">Edit</a>
				<a href="./?mod=berita&act=hapus&id=<?=$ID;?>" class="btn btn-danger ">Hapus</a>
